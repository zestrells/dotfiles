...
1. Clone this repo to `~/.dotfiles` with:
    ...
    ```zsh
    git clone --recursive git@github.com:zestrells/dotfiles.git ~/.dotfiles
    ```
...
.macos inspired by [Mathias Bynens](https://github.com/mathiasbynens/dotfiles/blob/master/.macos) and [Kevin Suttle's](https://github.com/kevinSuttle/MacOS-Defaults) repos.